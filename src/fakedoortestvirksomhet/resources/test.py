...
For å løse dette kan Sikt sin søknad- og interessemeldingsløsning brukes som en enkel måte å samle inn interessemeldinger for dataressurser som ikke er klare for deling. Brukere kan registrere sitt behov ved å klikke på "Gi meg tilgang" og skrive inn formålet med forespørselen.
